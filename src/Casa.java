...
public class Casa extends Inmueble{
    ...
    public Casa(String codigoNacional, String direccion, double area, BigDecimal valorComercial, int estrato, TipoInmuebleEnum tipo) {
    ...
    public BigDecimal calcularImpuesto() {
        ...
        BigDecimal constante= new BigDecimal(0.9);
